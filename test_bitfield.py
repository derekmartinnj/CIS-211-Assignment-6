...
class Test_Independent_Fields(unittest.TestCase):

    def test_independent_extract(self):
        x = 42  # 0b101_010
        bitfield = BitField(0, 2)
        extracted = bitfield.extract(x)
        assert x == 42


    def test_independent_insert(self):
        x = 42  # 0b101_010
        bitfield = BitField(3, 5)
        inserted = bitfield.insert(1, x)
        assert x == 42
